# PostgreSQL Protocol 3.0 Documentation: protocol-error-fields.html

> Source: [https://www.postgresql.org/docs/current/protocol-error-fields.html](https://www.postgresql.org/docs/current/protocol-error-fields.html)
...
LOG
 ...
 (in a notice message). This is identical to the 
S
...
Internal position: this is defined the same as the 
P
...
| Prev | Up | Next |
| --- | --- | --- |
| 54.7. Message Formats | Home | 54.9. Logical Replication Message Formats |
